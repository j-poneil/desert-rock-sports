...
export const tiers = [
    {
        ...
        tierDescription: "<p>Our Tier 1 day is aimed at either people who have never climbed at all, or only have a small amount of experience. Top roped sport or trad climbing is the norm. Flexible difficulty range. Locations with short approach hikes.</p><p>Half day is great for situations like: you don't have a lot of time to take advantage of, you just want to get a taste for climbing, or its summer and we have to chase the shade. This is a good gym-to-crag skills option for those looking to transition from climbing in a gym to climbing outside.</p><p>We can also do intros to lead climbing, intros to multipitch, intros to trad, self rescue, instruction on certain types of climbing such as crack climbing and offwidth climbing, etc... We are pretty flexible, just keep in mind that with 4-5h there is only so much we can teach. A full day or multiple half-days may work better for certain skill sets where practice is very beneficial.</p><p>There are a few short multipitch climbs that fit in Tier 1 and we can typically fit one of them into a half day:</p><ul><li>Man's Best Friend 5.7 2p sport</li><li>Big Bad Wolf 5.9 3p sport</li><li>Physical Graffiti 5.7 2p trad</li><li>etc...</li></ul>",
        costTable: [
            {1: '$225'},
            {2: '$300'},
            {3: '$420'},
    ...
    },
    {
        ...
        tierDuration: "7-8 Hours (+/-)",
        tierDescription: "<p>Our Tier 2 is designed for classic multipitch routes in the canyons of typically 4-6 pitches, sometimes 7. Due to the nature of the Red Rock Canyon, these are all traditional routes. Prior experience removing placed trad gear is nice to have, but not necessary, we can teach you how on the ground before we climb.</p><p>Since there is potential for other parties to be on the route and we can't control how fast they climb, the duration of the day is an estimate. Some routes we can rappel down, others we must walk off. Popular routes include classics like:</p><ul><li>Cat in the Hat 5.6 6p</li><li>Olive Oil 5.7 5p</li><li>Tunnel Vision 5.7 6p</li><li>Birdland 5.7+ 6p</li><li>Dark Shadows 5.8 4p</li><li>Purblind Pillar 5.8 6p</li><li>Frogland 5.8 6p</li><li>Y2K 5.10a 4p</li></ul>",
        costTable: [
            {1: "$350"},
            {2: "$600"}
        ],
        tierNotes: "<p>We add $50 for any route that is accessed from the Late Night trailhead system, such as Black Velvet Canyon.</p><p>In multipitch we limit it to 2 clients per guide, anything higher is excessively complicated, slow, and fairly rude to any other climbing parties who may be stuck waiting for excessively long times below.</p><p>If the approach and/or descent hikes are long enough, we may bump it up to a Tier 3 day, even if the number of pitches is low. We are going mostly by an estimate of the number of hours needed. Ex. The route, Northeast Arete on Bridge Mtn is 5.5 5p... but thats after many miles of complicated hiking and the descent hike is something like 8-10mi. The hike to the route easily takes much longer than it takes to actually climb the route.</p>"
    },
    {
        key: 3,
        img: Levitation29,
        ...
        tierDescription: "<p>Tier 3 is for considerably longer multipitch routes in the canyons. Long approaches, linkups of multiple routes, full on adventure, long walkoffs are typical, views are amazing. Popular choices:</p><ul><li>Johnny Vegas 5.7 4p + Solar Slab 5.6 9p (rap or walk off)</li><li>MysterZ 5.7 7p + Armatron 5.9 6p</li><li>Dark Shadows to the summit of the Mescalito 5.8 10+ pitches</li><li>Hot Flash 5.8 10p</li><li>Crimson Chrysalis 5.8+ 9p</li><li>Black Orpheus 5.9+ 8p</li><li>Epinephrine 5.9 13p</li><li>Resolution Arete 5.10 A1 24p</li><li>Inti Watana 5.10c 12p</li><li>Woman of Mountain Dreams 5.11a/b 17p</li><li>Levitation 29 5.11b/c 9p</li><li>The Original Route 5.12- 14p</li></ul>",
        costTable: [
            {1: "$400 to $600"},
            {2: "$700 to $900"}
        ],
