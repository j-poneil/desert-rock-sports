...
export const guides = [
    ...
    },
    {
        ...
        bio1: "From ATX, couldn't resist the draw of Red Rock Sandstone.",
        bio2: "Loves easy multipitch, cracks, offwidths.",
    ...
    },
    {
        ...
        exp: "",
        bio1: "Tracy likes to rock climb and create art. But because she must work, she splits her time between being a certified AMGA Rock Climbing Guide, Graphic Artist and as a struggling arteest. She lives and plays in Las Vegas, NV with her 2 kitties, Oscar and Bounce.",
        bio2: "",
        bio3: "",
        pic: Tracy,
    ...
    },
    {
        ...
        bio3: "Elaina has appeared in the Women of Climbing Calendar in 2001 and 2003 and is also featured in photographer Chris Noble’s book called Women Who Dare: North America's Most Inspiring Women Climbers, alongside her climbing heroes Lynn Hill and Kitty Calhoun.",
        pic: Elaina,
    ...
    },
    {
        ...
        bio1: "I began my career on the sculpted meta-sandstone escarpments of the North Carolina High Country at the height of the Eastern Continental Divide. I received my Bachelors of Science in Recreation Management from Appalachian State University in 2012 and subsequently began my guiding career by earning my AMGA Single Pitch Instructor certification later that year.",
        bio2: "I currently reside in Las Vegas, guiding out of Red Rock National Conservation Area, Joshua Tree National Park, the Sierra, and Moab. During the summer, I spend my time guiding in the Cascades as well as Wyoming in locations such as the Tetons and the Winds.",
        bio3: "Musician by night.",
        pic: Cody,
