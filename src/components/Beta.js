        ...
        <Container fluid>
            ...
            <Row xxl={3} xl={3} lg={3} md={2} sm={2} xs={1}>
                ...
                <Col>
                    <Card>
                        <Card.Body>
                            <Card.Title>Emergency and Rescue</Card.Title>
                            <Card.Text>
                ...
                <Col>
                    ...
                    <Accordion id="SNCC-ethics-camping-showers-laundry">
                        <Card>
                            ...
                            <Accordion.Toggle as={Card.Header} eventKey="1">Local Ethics</Accordion.Toggle>
                            ...
                            <Accordion.Toggle as={Card.Header} eventKey="2">Paid Camping Options</Accordion.Toggle>
                            ...
                            <Accordion.Toggle as={Card.Header} eventKey="3">Free Camping and "Vanlife" Options</Accordion.Toggle>
                            ...
                            <Accordion.Toggle as={Card.Header} eventKey="4">Where to get a shower?</Accordion.Toggle>
                            ...
                            <Accordion.Toggle as={Card.Header} eventKey="5">Where to do laundry?</Accordion.Toggle>
