    ...
    data: [
        {
            ...
            subSectionContent: () => (
                <>
                    ...
                    <div>
                        <Card.Text>The Visitor Center is open daily from 9:00 AM - 4:30 pm. The Scenic Drive is open every day of the year with hours changing slightly according to the season:</Card.Text>
