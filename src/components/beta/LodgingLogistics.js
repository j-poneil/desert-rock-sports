    ...
    data: [
        {
            ...
            subSectionContent: () => (
                <>
                    <Card.Text>( There are too many options in Vegas to list them all )</Card.Text>
                    ...
                    <Card.Text>The closest option to Red Rock Canyon. Recommended if you are serious about getting a lot of climbing in due to the short commute to Red Rock. Remember, if your going for big and/or popular multipitch, you want to be one of the first parties at the trailhead. Short commute = more sleep = better climbing.</Card.Text>
                    <Card.Subtitle>AirBNB, Vrbo, etc... vacation rental houses</Card.Subtitle>
                    <Card.Text>The casinos are rather hostile to vacation rental houses, however there are still enough options. This is a good way to go if you are going with a big group of friends who can split the cost. Remember to try to book in advance!</Card.Text>
                    <Card.Subtitle>The Strip...</Card.Subtitle>
                    <Card.Text>If you stay at the strip, its unlikely that you will get as much climbing in with the distractions and hassle of commuting so much further every morning and evening. Not recommended unless you are looking for The Strip experience itself and less so climbing.</Card.Text>
                </>
            )
        },
        {
        ...
        },
        {
            ...
            subSectionContent: () => (
                <>
                    ...
                    <Card.Text>Backcountry camping is allowed within Red Rock Canyon National Conservation Area above 5,000 feet in the Rainbow Mountain Wilderness, and above 6,500 feet in the La Madre Mountain Wilderness. A permit is required and can be obtained by calling: 702-515-5050. (number still applicable?).</Card.Text>
                    <Card.Text>Camping is also allowed on BLM managed public land outside of the Las Vegas Valley for up to two weeks without charge. Popular primitive (no facilities) sites include Bitter Spring Back Country Byway, Gold Butte Back Country Byway, Knob Hill, Virgin Mountains, Christmas Tree Pass and Logandale Trails System.</Card.Text>
                    <Card.Text>Presumably you could drive using Rocky Gap Road, a quite serious 4x4 only road with significant rock crawling required that connects Willow Springs inside the scenic loop with Lovell Canyon outside of it... and then only have a short hike to a suitable spot to backcountry camp... if breaking down in a remote area with zero cell reception sounds fun... The backcountry camping is meant more for people hiking and camping longer remote objectives like Bridge Mountain or various Red Rock peak linkups.</Card.Text>
                    <br />
                    ...
                    <Card.Text>
                        ...
                        Great high elevation option to avoid the summer Vegas temperatures and stay close to the limestone sport climbing around Mt Charleston. There is an open free campground without amenities near the end, but plenty of pulloffs along the way, many are far from level however.
                    </Card.Text>
