        ...
        <Container fluid className="mt-3">
            ...
            <Row xxl={2} xl={2} lg={2} md={1} sm={1} xs={1}>
                ...
                <Col className="mb-3">
                    <Card style={{'height': '100%'}}>
                        <Card.Body>
                            <Card.Title>An example of dry surface and wet interior</Card.Title>
                            {/*
                ...
                <Col className="mb-3">
                    <Card style={{'height': '100%'}}>
                        <Card.Body>
                            ...
                            <Card.Text>Hard to be sure! Depends on how much rain the desired objective's area got hit with, ambient day and night temperatures, humidity, its sun exposure, wind, etc... Areas that get a ton of sun and wind will dry faster. Areas that stay in shade will take much longer.</Card.Text>
                            <Card.Text>... Since its hard to know exactly how much rain hit any given area unless you were actually out there the entire time it was happening, its hard to know how wet it is. The rain gauges are not close enough or numerous enough to be much help (yet). Often the nearby rain gauges don't actually get hit with rain at all. Word of mouth from people who were actually there at the time is the best info you can get. Not simply at Red Rock, but at the particular canyon in Red Rock that you are interested in climbing at. Often it rains overnight and no one was out there to know how bad it was until they hike out there to look.</Card.Text>

                            <h6>In the Summer</h6>
                            <Card.Text>Very sunny aspects are typically OK to climb in 24h if they only got a light sprinkle, 48-72h for heavier rains.</Card.Text>
                            <Card.Text>Very shady aspects are typically OK to climb in 48-72h if they only got a light sprinkle, 96h+ for heavier rains.</Card.Text>

                            <h6>In the Winter</h6>
                            <Card.Text>Very sunny aspects are typically OK to climb in 48h if they only got a light sprinkle, 72-96h+ for heavier rains.</Card.Text>
                            <Card.Text>Very shady aspects are typically OK to climb a week later.</Card.Text>

                            <h6>The Horde Effect</h6>
                            <Card.Text>Red Rock routes when they are brand new typically have tons of loose rock, weak flake holds, weak edges on holds, etc... As more people climb these routes, wet or not, these weaker parts break off. Classic and mega-classic routes with high hundreds to thousands of noted ascents on Mountain Project are typically much cleaner with very little loose rock left, unless the loose and dangerously weak holds are very obvious and everyone avoids them.</Card.Text>
                            <Card.Text>If you are trying to avoid the crowds and seeking out obscure routes, beware to give the rock extra time to dry and/or be extra mindful as you climb of what you are using for holds and where you are placing pro.</Card.Text>
                        </Card.Body>
                    </Card>
                </Col>
                <Col className="mb-3">
                    <Card style={{'height': '100%'}}>
                        <Card.Body>
                            ...
                            <Card.Text>This is a good place to ask about weather and if it rained at Red Rock and how long until your area of interest is probably dry enough. Chances are that there is already discussion if there has been recent rain.</Card.Text>
                            ...
                            <Card.Text>Nevada specific forum section on Mountain Project. Another good option to look for threads about recent weather or ask.</Card.Text>
                ...
                <Col className="mb-3">
                    <Card style={{'height': '100%'}}>
                        <Card.Body>
                            <Card.Title>How to help the wet rock situation</Card.Title>
                            <h5>Add internet connected weather stations!</h5>
                            <Card.Text>Stations that record rainfall data and automatically upload/share it with weather services such as Weather Underground. Areas that need it most: Calico Basin, Spring Mountain Ranch, Bonnie Springs, Blue Diamond, Mountain Springs. The more places with data we can look at the better. Currently there is a station at the Scenic Loop Visitor Center, Mountain Springs Fire Department, and maybe Spring Mountain Ranch (I think maybe it isn't hooked up to the internet).</Card.Text>
                            <Card.Text>
                            ...
                            <Card.Text>Hike or trail run into areas after rains and share observations, pictures, videos of how wet things look. You can share these observations to the Vegas Climbers Facebook Group or in the Mountain Project Nevada Forum. This is immensely helpful. The vast majority of the people who climb at Red Rock Canyon are just passing through and largely have no idea the weather the day before, let alone several days. As well no clue about the wet rock issues and ethics. As there isn't any sort of offical BLM effort to provide signage as people drive out towards Red Rock Canyon, this is the best we can do to get the word out.</Card.Text>

                            <h5>Social Media</h5>
                            <Card.Text>If its too wet to climb safely, and you spend way too much time on Instagram, share that in a post and story along with what you will be doing instead. There are so many great alternatives to do here, wether that be climbing limestone or granite, trail running, hiking, visiting a hot spring, skiing (in winter, at Lee Canyon or SW Utah) or visiting one of the numerous other day-trip-able areas around.</Card.Text>
                            
                            <h5>DON'T CLIMB WET ROCK</h5>
                            <Card.Text>If you see climbers climbing, but the ground is obviously still too wet, don't think that its OK because they are doing it. They are doing it because they don't know any better. Know better. Be better.</Card.Text>
                            <Card.Text>Some local route developers have gone so far as putting up a sign or removing the first bolt hanger on routes they developed to try to disuade people from climbing them when they are too wet. Big Bad Wolf 5.9, the most popular multipitch route in Nevada, and many peoples first multipitch ever, has a crux where you have to use some small flake holds. If/when these break it will drastically change the difficulty and permanently ruin it for future beginner climbers. There are very few sport multipitch routes in Red Rock Canyon, by necessity of what the rock provides and the ban of bolting in the canyons, which are a wilderness area. Lets try not to ruin it for others, OK?</Card.Text>

                            <h5>Inform climbers you see (gently)</h5>
                            <Card.Text>Inform any climbers ignoring or oblivious to the situation. Please be gentle and explain. As noted, most of those climbing at Red Rocks on any given day are passing through or just flew in a day or two before. They are used to other rock types that don't lose strength when wet, the rock surface will probably appear dry, and they probably didn't check the historical weather... but even if they did, as noted before, the closest rain gauge often doesn't register what actually happens out in the calico pullouts and especially not the deeper canyons.</Card.Text>
                            <Card.Text>We know that it is super frustrating to have your trip ruined by rain... but how bad will your trip be when you break a hold and take a bad fall and break a bone? Or permanently damage a route ruining it for future climbers? It doesn't make it OK and acceptable to climb and damage routes just because you have spent time and money to come here.</Card.Text>

                            <h5>Ask experienced locals when you are unsure</h5>
                            <Card.Text>Please ask others in the Vegas Climbers Facebook Group or Mountain Project Nevada Forum if they think its OK to climb tomorrow at the area and wall(s) you are wanting to go to. <strong>As a last resort,</strong> you can call us, however we typically have not had time to get out and see ourselves, we are typically only going off what we have read in those above mentioned places or what it looks like down the road from us. As you can imagine, after any given rain, the next day, we are bombarded by calls asking if it is dry enough or when we think it will be dry.</Card.Text>
                        </Card.Body>
                    </Card>
                </Col>
                {/* <Col className="mb-3">
