...
//! I uninstalled it, would need to re-install it to use it again
...
//!
/*
    Decided that I wont use Light Gallery... instead I'll combine a good responsive grid arranger with a different lightbox
*/
...
const GuidingGalleryOld = () => {
    return (
        <Gallery />
    )
}

export default GuidingGalleryOld;
